...
map.getView().fit([3158096.526070, 3308004.395750, 3978980.353799, 3783579.127451], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">الموافقات البيئية لشهر يناير 2026</h2>';
        return titleElement;
    })(),
